class AddDecimalColumnsConstrains < ActiveRecord::Migration
  ...
  def down
    ...
    change_column :inventory_item_prices, :value, :decimal, null: true, default: nil, precision: 8, scale: 2
    change_column :inventory_items, :moving_average_cost, :decimal, null: true, default: nil, precision: 8, scale: 2
